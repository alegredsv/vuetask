    ...
    template:` <table class="table">
                        ...
                        <tr v-for="(index, o) in bills">
                            ...
                            <td>
                               ...
                               <span style="margin: 5px;cursor: pointer;" v-link="{name: 'bill-receive.update', params:{index:index}}"  title="Editar" aria-hidden="true" class="glyphicon glyphicon-pencil"></span>
